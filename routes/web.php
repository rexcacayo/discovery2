...
Route::namespace('Frontend')->prefix('pages')->group(function () {
    ...
    // Cuestionario Frontend Route
    Route::get('/cuestionarios', 'CuestionariosController@index')->name('cuestionario.frontend.index');
...
Route::middleware(['role:admin', 'auth'])->namespace('Backend')->prefix('backend')->group(function () {
    ...
    Route::get('/cuestionarios/recorrido/{cuestionario}', 'CuestionariosController@cuestionario')->name('cuestionario.recorrido');
    Route::post('/cuestionarios/save', 'CuestionariosController@post')->name('cuestionario.save');
    Route::post('/cuestionarios/paso', 'CuestionariosController@guardarrespuesta')->name('cuestionario.paso');
