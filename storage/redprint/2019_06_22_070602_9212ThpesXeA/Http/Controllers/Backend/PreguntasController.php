...
class PreguntasController extends Controller
{
    ...
    public function form(Pregunta $pregunta = null)
    {
		...
		$parametros = \App\Parametro::pluck('formulario', 'id')->toArray();
		return view('backend.preguntas.form')->with('pregunta', $pregunta)->with('parametros', $parametros);
    }
...
$pregunta->parametro_id = $request->get('parametro_id');
        $pregunta->save();
